        ...
        return SizedBox(
          ...
          child: Row(
            ...
            children: [
              Expanded(
                child: FSlider(
                  label: Text('Масштаб шрифта'),
                  control: FSliderControl.managedDiscrete(
                    initial: FSliderValue(max: percentToSlider(state.fontScale)),
                    onChange: (value) {
                      cubit.setSettings(fontScale: sliderToPercent(value.max));
                    },
                  ),
                  tooltipBuilder: (controller, value) {
                    return Text(
              ...
              FButton.icon(
                onPress: () {
                  cubit.setSettings(fontScale: 1.0);
                },
                child: Icon(Icons.restart_alt),
              ),
            ],
